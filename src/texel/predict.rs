...
pub fn predict(f: &TexelFeatures, w: &TunableWeights) -> i32 {
    ...
    // ── Threats (Phase 24 item 4, D68; extended Phase 34.2, Session 133) ──
    let mut th = 0i64;
    ...
    th += w.threat_by_rook * f.threat_by_rook_diff as i64;
...
fn king_safety_side(
    ...
    let shelter_bonus =
        knights_near_king * w.knight_near_own_king + bishops_near_king * w.bishop_near_own_king;
